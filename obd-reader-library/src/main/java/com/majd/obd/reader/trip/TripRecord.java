package com.majd.obd.reader.trip;
...
import com.majd.obd.reader.enums.FuelType;
import com.majd.obd.reader.obdCommand.ObdCommand;
import com.majd.obd.reader.obdCommand.SpeedCommand;
...
public class TripRecord implements DefineObdReader {
    ...
    public float getmIntakePressure(){return mIntakePressure;}
    public float getmIntakeAirTemp(){return mIntakeAirTemp;}
    ...
    public String getmFuelLevel(){return mFuelLevel;}
   ...
   private ArrayList<ObdCommand> mObdCommandArrayList;
    ...
    public String toString() {
        return "OBD data ::" +
                "\n" + "Trip Distance Traveled : " + getmDistanceTravel()+
